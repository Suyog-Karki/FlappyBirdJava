...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
    ...
    private static final String HIGH_SCORE_FILE = "flappybird_highscore.txt";
    ...
    void loadHighScore() {
        try {
            ...
            System.out.println("Error parsing high score: " + e.getMessage());
            highScore = 0;
        }
    }
    ...
    void saveHighScore() {
        try {
            ...
            writer.write(String.valueOf((int) highScore));
            writer.close();
        } catch (IOException e) {
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver) {
            ...
            g.drawString("Press SPACE to restart", 10, 95);
        }
        else {
            g.drawString(String.valueOf((int) score), 10, 35);
            g.setFont(new Font("Arial", Font.PLAIN, 20));
            g.drawString("High: " + String.valueOf((int) highScore), 10, 60);
        }
    }
    ...
    public void actionPerformed(ActionEvent e) { //called every x milliseconds by gameLoop timer
        ...
        if (gameOver) {
            placePipeTimer.stop();
            gameLoop.stop();
            updateHighScore(); // Save high score when game ends
        }
    }
